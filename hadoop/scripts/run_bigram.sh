...
MAPPER="$STREAM_DIR/mapper_bigram.py"
REDUCER="$STREAM_DIR/reducer_bigram.py"
COMBINER="$STREAM_DIR/combiner_bigram.py"
...
chmod +x "$MAPPER" "$REDUCER" "$COMBINER"
